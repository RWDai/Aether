...
use crate::gateway::constants::{
    ...
    LEGACY_GATEWAY_BRIDGE_ROUTE_GROUPS, PYTHON_ONLY_MIDDLEWARE_GROUPS, PYTHON_ONLY_ROUTE_GROUPS,
    PYTHON_ONLY_RUNTIME_COMPONENTS, READYZ_PATH, RUST_FRONTDOOR_OWNED_ROUTE_PATTERNS,
};
    ...
    Json(json!({
        ...
        "python_host_boundary": {
            ...
            "legacy_bridge": {
                ...
                "status": "remove_after_rust_control_plane_cutover",
            },
        },
        "features": {
            "control_api_configured": state.control_base_url.is_some(),
            "executor_api_configured": state.executor_base_url.is_some(),
