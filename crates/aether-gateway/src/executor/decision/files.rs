...
use super::super::{
    ...
    EXECUTOR_SYNC_DECISION_ACTION, GEMINI_FILES_DELETE_PLAN_KIND, GEMINI_FILES_DOWNLOAD_PLAN_KIND,
    GEMINI_FILES_GET_PLAN_KIND, GEMINI_FILES_LIST_PLAN_KIND, GEMINI_FILES_UPLOAD_PLAN_KIND,
};
...
pub(in crate::gateway::executor) async fn maybe_execute_sync_via_local_gemini_files_decision(
    state: &AppState,
...
pub(in crate::gateway::executor) async fn maybe_execute_stream_via_local_gemini_files_decision(
    state: &AppState,
    control_base_url: &str,
    executor_base_url: &str,
    parts: &http::request::Parts,
...
pub(in crate::gateway::executor) async fn maybe_build_sync_local_gemini_files_decision_payload(
    state: &AppState,
    parts: &http::request::Parts,
    body_json: &serde_json::Value,
    body_base64: Option<&str>,
...
pub(in crate::gateway::executor) async fn maybe_build_stream_local_gemini_files_decision_payload(
    state: &AppState,
    parts: &http::request::Parts,
    trace_id: &str,
    decision: &GatewayControlDecision,
