...
use super::super::{
    GatewayControlSyncDecisionResponse, EXECUTOR_SYNC_DECISION_ACTION,
    GEMINI_VIDEO_CREATE_SYNC_PLAN_KIND, OPENAI_VIDEO_CREATE_SYNC_PLAN_KIND,
};
...
pub(in crate::gateway::executor) async fn maybe_execute_sync_via_local_video_decision(
    state: &AppState,
...
pub(in crate::gateway::executor) async fn maybe_build_sync_local_video_decision_payload(
    state: &AppState,
    parts: &http::request::Parts,
    body_json: &serde_json::Value,
    trace_id: &str,
