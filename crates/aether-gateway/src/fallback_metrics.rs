...
impl GatewayFallbackMetricKind {
    fn metric_name(self) -> &'static str {
        match self {
            ...
            Self::LocalExecutorMiss => "local_executor_miss_total",
            Self::PublicProxyAfterExecutorMiss => "public_proxy_after_executor_miss_total",
    ...
    fn help(self) -> &'static str {
        match self {
            ...
            Self::LocalExecutorMiss => {
                "Number of requests that were terminated locally after executor miss because Python fallback was removed."
            }
            Self::PublicProxyAfterExecutorMiss => {
                "Number of requests that fell through to Python public proxy after executor miss."
            }
            ...
            Self::LegacyInternalBridge => {
                "Number of requests that still used the legacy internal gateway bridge."
            }
...
impl GatewayFallbackReason {
    pub(crate) fn as_label_value(self) -> &'static str {
        match self {
            ...
            Self::ExecutorMiss => "executor_miss",
