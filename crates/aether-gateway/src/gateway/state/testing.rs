...
impl AppState {
    ...
    {
        self.data = Arc::new(GatewayDataState::with_video_task_repository_for_tests(
            repository,
        ));
        self
    }
    ...
    pub(crate) fn with_user_data_reader_for_tests(
        ...
        self.data = Arc::new(GatewayDataState::with_user_reader_for_tests(repository));
        self
    }
    ...
    {
        self.data = Arc::new(GatewayDataState::with_usage_repository_for_tests(
            repository,
        ));
        self
    }
    ...
    where
        I: IntoIterator<Item = crate::gateway::data::StoredUserSessionRecord>,
    {
        let store = self
            .auth_session_store
            .get_or_insert_with(|| Arc::new(StdMutex::new(HashMap::new())));
