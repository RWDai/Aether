...
async fn gateway_executes_claude_code_cli_sync_via_local_decision_gate_without_python_decision_sync(
    ...
    assert_eq!(seen_executor_request.accept, "application/json");
    ...
    assert_eq!(seen_executor_request.x_stainless_helper_method, "");
    assert_eq!(seen_executor_request.x_stainless_package_version, "1.0.5");
