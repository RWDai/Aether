...
async fn gateway_executes_kiro_claude_cli_sync_via_local_provider_catalog_candidate_after_refresh()
{
    ...
    assert_eq!(seen_executor_request.current_content, "hello refresh");
