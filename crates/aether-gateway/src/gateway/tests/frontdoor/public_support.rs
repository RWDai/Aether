    ...
    let gateway = build_router_with_state(
        AppState::new(upstream_url, None)
            ...
            .with_data_state_for_tests(
                crate::gateway::data::GatewayDataState::with_announcement_reader_for_tests(
...
async fn gateway_creates_announcement_locally_with_trusted_admin_principal() {
    ...
    let gateway = build_router_with_state(
        AppState::new(upstream_url, None)
            .expect("gateway should build")
            .with_data_state_for_tests(
                crate::gateway::data::GatewayDataState::with_announcement_repository_for_tests(
...
async fn gateway_handles_public_catalog_site_info_without_proxying_upstream() {
    ...
    let gateway = build_router_with_state(
        AppState::new(upstream_url, None)
            .expect("gateway should build")
            .with_data_state_for_tests(
                crate::gateway::data::GatewayDataState::disabled()
...
async fn gateway_handles_public_catalog_models_without_proxying_upstream() {
    ...
    let gateway = build_router_with_state(
        AppState::new(upstream_url, None)
            .expect("gateway should build")
            .with_data_state_for_tests(
                crate::gateway::data::GatewayDataState::with_global_model_reader_for_tests(
...
async fn gateway_handles_public_catalog_stats_without_proxying_upstream() {
    ...
    let gateway = build_router_with_state(
        AppState::new(upstream_url, None)
            .expect("gateway should build")
            .with_data_state_for_tests(
                crate::gateway::data::GatewayDataState::with_provider_catalog_and_minimal_candidate_selection_for_tests(
                    provider_catalog_repository,
...
async fn gateway_handles_public_health_api_formats_without_proxying_upstream() {
    ...
    let gateway = build_router_with_state(
        AppState::new(upstream_url, None)
            .expect("gateway should build")
            .with_data_state_for_tests(
                crate::gateway::data::GatewayDataState::with_provider_catalog_and_request_candidate_reader_for_tests(
                    provider_catalog_repository,
...
async fn gateway_handles_public_auth_modules_status_without_proxying_upstream() {
    ...
    let gateway = build_router_with_state(
        AppState::new(upstream_url, None)
            .expect("gateway should build")
            .with_data_state_for_tests(
                crate::gateway::data::GatewayDataState::with_auth_module_reader_for_tests(
...
async fn gateway_handles_auth_registration_settings_without_proxying_upstream() {
    ...
    let data_state = crate::gateway::data::GatewayDataState::with_auth_module_reader_for_tests(
...
async fn gateway_handles_auth_settings_without_proxying_upstream() {
    ...
    .with_system_config_values_for_tests(vec![("module.ldap.enabled".to_string(), json!(true))]);
...
async fn gateway_handles_public_test_connection_without_proxying_python_upstream() {
    ...
    let gateway = build_router_with_state(
        AppState::new(python_upstream_url, None)
            .expect("gateway should build")
            .with_data_state_for_tests(
...
) -> crate::gateway::data::StoredUserSessionRecord {
    crate::gateway::data::StoredUserSessionRecord::new(
...
async fn start_auth_gateway_with_state(
    ...
    sessions: impl IntoIterator<Item = crate::gateway::data::StoredUserSessionRecord>,
) -> (
    String,
    Arc<Mutex<usize>>,
    ...
    let state = AppState::new(upstream_url, None)
        .expect("gateway should build")
        .with_data_state_for_tests(
            crate::gateway::data::GatewayDataState::with_user_and_wallet_for_tests(
                user_repository,
                wallet_repository,
            ),
        )
    ...
    T: aether_data::repository::usage::UsageRepository + 'static,
{
    ...
    let state = AppState::new(upstream_url, None)
        .expect("gateway should build")
        .with_data_state_for_tests(
            crate::gateway::data::GatewayDataState::with_user_wallet_and_usage_for_tests(
                user_repository,
                wallet_repository,
                usage_repository,
            ),
    ...
    TCatalog: aether_data::repository::provider_catalog::ProviderCatalogReadRepository + 'static,
{
    ...
    let user_repository = Arc::new(InMemoryUserReadRepository::seed_auth_users(vec![user]));
    let wallet_repository = Arc::new(InMemoryWalletRepository::seed(vec![wallet]));
    let data_state = crate::gateway::data::GatewayDataState::with_user_wallet_and_usage_for_tests(
        user_repository,
        wallet_repository,
        usage_repository,
    )
...
async fn start_auth_gateway_with_preferences_state(
    ...
    wallet: StoredWalletSnapshot,
    sessions: impl IntoIterator<Item = crate::gateway::data::StoredUserSessionRecord>,
    preferences: impl IntoIterator<Item = crate::gateway::data::StoredUserPreferenceRecord>,
) -> (
    String,
    Arc<Mutex<usize>>,
    tokio::task::JoinHandle<()>,
        ...
        + 'static,
{
    ...
    let state = AppState::new(upstream_url, None)
        .expect("gateway should build")
        .with_data_state_for_tests(
            crate::gateway::data::GatewayDataState::with_announcement_user_and_wallet_for_tests(
                announcement_repository,
                user_repository,
                wallet_repository,
            ),
...
async fn gateway_handles_user_monitoring_rate_limit_status_locally_without_proxying_upstream() {
    ...
    let (gateway_url, upstream_hits, gateway_handle, upstream_handle) =
        start_auth_gateway_with_builder(|upstream_url| {
            let data_state =
                crate::gateway::data::GatewayDataState::with_auth_api_key_repository_for_tests(
                    auth_repository,
                )
...
async fn gateway_handles_users_me_preferences_locally_without_proxying_upstream() {
    ...
    let (gateway_url, upstream_hits, gateway_handle, upstream_handle) =
        start_auth_gateway_with_preferences_state(
            ...
            std::iter::empty::<crate::gateway::data::StoredUserPreferenceRecord>(),
        )
        .await;
...
async fn gateway_handles_users_me_management_token_reads_locally_without_proxying_upstream() {
    ...
    let (gateway_url, upstream_hits, gateway_handle, upstream_handle) =
        start_auth_gateway_with_builder(|upstream_url| {
            let data_state =
                crate::gateway::data::GatewayDataState::with_management_token_repository_for_tests(
                    repository,
                )
                .with_user_reader(user_repository);
            AppState::new(upstream_url, None)
...
async fn gateway_handles_auth_ldap_login_locally_without_proxying_upstream() {
    ...
    let (gateway_url, upstream_hits, gateway_handle, upstream_handle) =
        start_auth_gateway_with_builder(|upstream_url| {
            ...
            let data_state = crate::gateway::data::GatewayDataState::disabled()
                .with_encryption_key_for_tests(DEVELOPMENT_ENCRYPTION_KEY)
