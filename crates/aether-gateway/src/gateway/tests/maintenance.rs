...
async fn gateway_background_request_candidate_cleanup_deletes_expired_entries_in_batches() {
    ...
    let data_state =
        crate::gateway::data::GatewayDataState::with_request_candidate_repository_for_tests(
...
async fn gateway_provider_checkin_runs_local_query_balance_for_configured_provider() {
    ...
    .with_data_state_for_tests(
        crate::gateway::data::GatewayDataState::with_provider_catalog_repository_for_tests(
            repository,
        )
        .with_system_config_values_for_tests([
