fn provider_catalog_key_supports_format(key: &StoredProviderCatalogKey, api_format: &str) -> bool {
...
fn key_api_formats_without_entry(
...
fn admin_health_key_id(request_path: &str) -> Option<String> {
...
fn admin_recover_key_id(request_path: &str) -> Option<String> {
...
fn admin_rpm_key_id(request_path: &str) -> Option<String> {
...
fn admin_provider_id_for_endpoints(request_path: &str) -> Option<String> {
...
fn admin_endpoint_id(request_path: &str) -> Option<String> {
...
fn admin_default_body_rules_api_format(request_path: &str) -> Option<String> {
...
fn endpoint_key_counts_by_format(
...
fn build_admin_provider_endpoint_response(
