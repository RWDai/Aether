...
mod tests {
    ...
    use super::{
        ...
        resolve_direct_executor_sync_plan_kind, supports_stream_scheduler_decision_kind,
    ...
    fn resolves_openai_chat_plan_kinds() {
        ...
        assert_eq!(
            resolve_direct_executor_sync_plan_kind(&parts, &decision),
            Some("openai_chat_sync")
        );
        assert_eq!(
            resolve_direct_executor_stream_plan_kind(&parts, &decision),
