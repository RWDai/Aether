...
fn report_context_is_locally_actionable(report_context: Option<&Value>) -> bool {
...
async fn resolve_locally_actionable_report_context(
    state: &AppState,
    ...
    let task = if let Some(task_id) = local_task_id {
            ...
            .ok()?
        {
            ...
            state
                .data
                .find_video_task(
                    aether_data::repository::video_tasks::VideoTaskLookupKey::UserExternal {
                        user_id,
